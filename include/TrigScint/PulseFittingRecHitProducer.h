/**
 * @file PulseFittingRecHitProducer.h
...
/**
 * @class PulseFittingRecHitProducer
 * @brief Organizes digis into TrigScintHits, linearizes TDC
 * and ADC info, and converts amplitudes to PEs

 */
class PulseFittingRecHitProducer : public framework::Producer {
 public:
  PulseFittingRecHitProducer(const std::string& name, framework::Process& process);

  ~PulseFittingRecHitProducer();
